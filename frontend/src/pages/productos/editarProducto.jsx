...
import patchProducto from "../../controller/productos/patchProduct";
import  getProductById  from "../../controller/productos/getProductById";
...
function editarProducto() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault(); 
    try {
        const data = await patchProducto(id, formData);
